...
- Portal now preserves display rotation across re-provisioning instead of clobbering it with an uninitialized value
...
[Unreleased]: https://github.com/wx528/esp32-cyd-llm-usage/compare/v0.3.0...HEAD
[0.3.0]: https://github.com/wx528/esp32-cyd-llm-usage/releases/tag/v0.3.0
